...
using Modules.ApplicationCache;
...
namespace Dev.Editor
{
    public class EditorMenu
    {
        ...
        public static void ToggleCleanerAutoMode()
        {
        ...
        public static bool ToggleCleanerAutoModeValidate()
        {
        ...
        [MenuItem(itemName: WindowsMenu + "Pinning/Open ProjectPinWindow", priority = 0)]
        public static void OpenProjectPinWindow()
        {
            ProjectPinningWindow.Open();
        }

        [MenuItem(itemName: WindowsMenu + "Pinning/Open HierarchyPinWindow", priority = 1)]
        public static void OpenHierarchyPinWindow()
        {
            HierarchyPinningWindow.Open();
        }

        [MenuItem(itemName: WindowsMenu + "EditorStyleViewer/Open StyleViewerWindow", priority = 5)]
        public static void OpenStyleViewerWindow()
        {
            EditorStyleViewerWindow.Open();
        }

        [MenuItem(itemName: WindowsMenu + "CleanDirectory/Open CleanDirectoryWindow", priority = 7)]
        public static void OpenCleanDirectoryWindow()
        {
            CleanDirectoryWindow.Open();
        }

        [MenuItem(itemName: WindowsMenu + "ShaderVariant/Open ShaderVariantWindow", priority = 8)]
        ...
        [MenuItem(itemName: BuildMenu + "Open BuildInAssetsWindow", priority = 1)]
