...
{
	public sealed class TextureDirectionalLightmapInspectorDrawer : TextureDataInspectorDrawer
	{
		private bool foldoutAdvanced = false;

		public TextureDirectionalLightmapInspectorDrawer(TextureData textureData) : base(textureData){}
